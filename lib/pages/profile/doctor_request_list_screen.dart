...
import 'package:icare/widgets/items/doctor_request_item.dart';
...
class DoctorRequestsScreen extends StatelessWidget {
  DoctorRequestsScreen({Key? key}) : super(key: key);
  @override
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(
          title: CustomText(
            text: 'Requests of new Doctors',
              ...
              if(snapshot.hasData && snapshot.data!=null && snapshot.data!.isNotEmpty){
                return ListView.builder(
                  itemBuilder:(context, index) {
                    ...
                    return DoctorRequestItem(request:request);
                  },
  ...
  Future<List> getRequestsList()async{
    return await FirebaseMethods().getListFromFirestore(requestsCollection);
  }
